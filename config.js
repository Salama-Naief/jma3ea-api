...
module.exports = {
  ...
  order: {
    disabled_payment_methods: process.env.ORDER_DISABLED_PAYMENT_METHODS
      ? process.env.ORDER_DISABLED_PAYMENT_METHODS.split(",")
      : [],
    delivery_time_is_required:
      process.env.ORDER_DELIVERY_TIME_IS_REQUIRED === undefined ||
      process.env.ORDER_DELIVERY_TIME_IS_REQUIRED === true,
  },
  mobile: {
  ...
  data_to_save: process.env.IGNORE_REQUIRED_FIELDS
    ? process.env.IGNORE_REQUIRED_FIELDS.split(",")
    : [],
