...
module.exports.list = async function (req, res) {
    ...
    mainController.list_all(req, res, collectionName, {
        ...
        for (let inventory of out.data) {
            req.custom.clean_filter = { $or: [{ inventory_id: ObjectID(inventory._id.toString()) }, { inventory_id: inventory._id.toString() }], cities: ObjectID(cityid), is_external: true, status: true };
